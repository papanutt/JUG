...
uint256 hashGenesisBlock("0x00000de88dc27020d200b53063922948b964192782e279fca822473b711430db");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // JuggaloCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "JuggaloCoin Signed Message:\n";
...
{
    // JuggaloCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
static const int64 nTargetTimespan = 24 * 60 * 60; // JuggaloCoin: 1 day
static const int64 nTargetSpacing = 60; // JuggaloCoin: 1 minute
...
unsigned int static GetNextWorkRequired_V1(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // JuggaloCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
{
        static const int64 BlocksTargetSpacing = 60; // JuggaloCoin: 1 minute
        static const unsigned int TimeDaySeconds = 24 * 60 * 60; // JuggaloCoin: 1 day
...
{
    // JuggaloCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000de88dc27020d200b53063922948b964192782e279fca822473b711430db");
    }
...
bool InitBlockIndex() {
 ...
 if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0xdfc56ba7b5653591f99f734b66f33d970a072294da38f8dbf9984e8e431bfa8e"));
...
unsigned char pchMessageStart[4] = { 0xfe, 0xc3, 0xb9, 0xde }; // JuggaloCoin: increase each by adding 6 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("JuggaloCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("JuggaloCoinMiner : ProcessBlock, block not accepted");
    }
